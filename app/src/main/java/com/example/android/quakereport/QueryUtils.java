...
public final class QueryUtils {
     ...
     *
     */
    public static ArrayList<EQParameters> extractEarthquakes() {
        ...
        try {
            ...
            SimpleDateFormat dateFormatter = new SimpleDateFormat("yyyy-MM-dd hh:mm aaa");
            for(int i=0;i<features.length();i++){
                ...
                earthquakes.add(new EQParameters(mag,place,dateToDisplay,url));
